...
import 'package:flutter_crud_aldrin/paginas/editar_nota.dart';
import 'package:flutter_crud_aldrin/paginas/guardarPagina.dart';
...
class _ListPagesState extends State<ListPages> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Tareas-Notas-Aldrin'),
